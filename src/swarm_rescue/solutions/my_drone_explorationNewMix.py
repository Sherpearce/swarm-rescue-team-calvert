...
class MyDroneExploreMix(DroneAbstract):
    ...
    def control(self):
        ...
        if self.state is self.Activity.RESCUER or self.alone:
            ...
            if self.state is self.Activity.SEARCHING_WOUNDED and self.alone:
    ...
    def process_semantic_sensor(self):
        ...
        if (self.state is self.Activity.SEARCHING_WOUNDED
            ...
            for data in detection_semantic:
                ...
                # If the wounded person detected is held by another drone
                elif data.entity_type == DroneSemanticSensor.TypeEntity.WOUNDED_PERSON and data.grasped:
                    # We ignore the wounded person and we explore the map
                    pass
